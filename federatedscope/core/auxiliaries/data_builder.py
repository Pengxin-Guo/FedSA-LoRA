...
def get_data(config, client_cfgs=None):
    ...
    if dataset is not None:
        # translator = <class 'federatedscope.core.data.base_translator.BaseDataTranslator'> for LLM
        # also for GLUE dataset, added by me (only this notes)
        ...
        # Convert a centralized dataset to ``StandaloneDataDict``
